...
class BooksDataRepositoryTest {
    ...
    private val mapper = mock<BookMapper>()
    private val cacheStore = mock<BooksCacheDataStore>()
    private val remoteStore = mock<BooksRemoteDataStore>()
    private val cache = mock<BooksCache>()
    private val repository = BooksRepositoryImpl(mapper, cache, cacheStore, remoteStore)
